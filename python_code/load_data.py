...
loader = Neo4jLoader("neo4j://localhost:7687",
                     "neo4j", "your_secret_password")
cypher_query = """
CALL apoc.periodic.iterate(
  ...
  "
    ...
    // Create the (Radio)-[:PLAYS]->(Track) relationship
    ...
    // Include 'track' in this WITH clause to carry it over
    ...
    // Carry over 'track' here as well, along with 'row' and 'artist'
    WITH row, track, artist
    ...
    // Now 'track' is defined here, so this should work without error
    WITH row, track
